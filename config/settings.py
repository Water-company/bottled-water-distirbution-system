...
DELIVERY_ARRIVAL_THRESHOLD_METERS = int(os.getenv("DELIVERY_ARRIVAL_THRESHOLD_METERS", "30"))
LIVE_TRACKING_UPDATE_SECONDS = int(os.getenv("LIVE_TRACKING_UPDATE_SECONDS", "5"))
LIVE_TRACKING_CUSTOMER_POLL_SECONDS = int(os.getenv("LIVE_TRACKING_CUSTOMER_POLL_SECONDS", "5"))
